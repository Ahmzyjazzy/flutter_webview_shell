                ...
                children: <Widget>[
                  Expanded(
                    ...
                    child: ParallaxContainer(
                      child: Image.asset(
                        Setting.intro_images[info.index],
                        fit: BoxFit.contain,
                        height: 150,
                      ),
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: <Widget>[
                        Text(
                          Setting.intro_titles[_slideIndex],
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 20.0,
                        ...
                        Text(
                          Setting.intro_descriptions[_slideIndex],
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: active ? Setting.app_color : Color.fromRGBO(158, 158, 158, 0.52),
